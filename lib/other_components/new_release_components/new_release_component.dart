          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Center(child: Text("New Release Films",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.white),)),
              ),
              Expanded(
                child: FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.data == null){
                        return Image.network("https://cdn-icons-png.flaticon.com/512/891/891509.png",width: 150,);
